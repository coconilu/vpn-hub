...
- 状态：Accepted
- 日期：2026-07-22
- 关联：Issue #42；D-005、D-009、D-011、D-013
...
D-011 中“首次 Guardian 权威回读前保持可回滚”的要求由 D-013 收窄：可回滚承诺持续到本地 runtime 与双 `REJECT` 权威回读完成；首次完整 Guardian 不再是提交点。PID、Controller ownership、回滚、Secret Store 和 Fail Closed 约束保持不变。
